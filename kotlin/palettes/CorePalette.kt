 ...
 * @deprecated Use [dynamiccolor.DynamicScheme] for color scheme
 *   generation. Use [palettes.CorePalettes] for core palettes
 *   container class.
 */
@Deprecated(
...
class CorePalette private constructor(argb: Int, isContent: Boolean) {
  ...
  companion object {
     ...
     * @deprecated Use [dynamiccolor.DynamicScheme] for color
     *   scheme generation. Use [palettes.CorePalettes] for core
