...
import common.BiFunction
import common.Function
import contrast.Contrast
import contrast.Contrast.darkerUnsafe
import contrast.Contrast.lighterUnsafe
import contrast.Contrast.ratioOfTones
import hct.Hct
import palettes.TonalPalette
import scheme.DynamicScheme
import utils.MathUtils.clampDouble
import utils.MathUtils.clampInt
    ...
    fun getTone(scheme: DynamicScheme): Double {
        ...
        if (bgDynamicColor != null) {
            ...
            if (decreasingContrast) {
                ...
                minRatio = if (!bgHasBg) 1.0 else min(maxContrastRatio, standardRatio)
                maxRatio = if (!bgHasBg) 21.0 else max(maxContrastRatio, standardRatio)
            }
        }
