...
object Score {
    ...
    fun score(colorsToPopulation: Map<Int, Int>): List<Int> {
        ...
        for ((color, cam) in colorsToCam) {
            ...
            val chromaWeight = if (cam.chroma < TARGET_CHROMA) WEIGHT_CHROMA_BELOW else WEIGHT_CHROMA_ABOVE
        ...
        val entryList: List<Map.Entry<Int, Double?>> = ArrayList<Map.Entry<Int, Double?>>(filteredColorsToScore.entries).sortedWith(ScoredComparator())
