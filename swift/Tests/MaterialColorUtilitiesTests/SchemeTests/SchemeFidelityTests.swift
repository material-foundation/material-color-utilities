...
final class SchemeFidelityTests: XCTestCase {
  ...
  func testLightSchemeFidelityMinContrast() {
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiary.getArgb(scheme), 0xffd9_3628)
    XCTAssertEqual(MaterialDynamicColors.onTertiary.getArgb(scheme), 0xffff_fbff)
    XCTAssertEqual(MaterialDynamicColors.tertiaryContainer.getArgb(scheme), 0xffff_cdc6)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryContainer.getArgb(scheme), 0xffb9_1d14)
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixed.getArgb(scheme), 0xffff_cdc6)
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme), 0xffff_a699)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryFixed.getArgb(scheme), 0xff9e_0102)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryFixedVariant.getArgb(scheme), 0xffc5_271b)
  }
  ...
  func testLightSchemeFidelityStandardContrast() {
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiary.getArgb(scheme), 0xff77_0001)
    XCTAssertEqual(MaterialDynamicColors.onTertiary.getArgb(scheme), 0xffff_ffff)
    XCTAssertEqual(MaterialDynamicColors.tertiaryContainer.getArgb(scheme), 0xffb3_1910)
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixed.getArgb(scheme), 0xffff_dad5)
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme), 0xffff_b4a9)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryFixed.getArgb(scheme), 0xff41_0000)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryFixedVariant.getArgb(scheme), 0xff93_0002)
  }
  ...
  func testLightSchemeFidelityMaxContrast() {
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiary.getArgb(scheme), 0xff4e_0000)
    XCTAssertEqual(MaterialDynamicColors.onTertiary.getArgb(scheme), 0xffff_ffff)
    XCTAssertEqual(MaterialDynamicColors.tertiaryContainer.getArgb(scheme), 0xff8c_0002)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryContainer.getArgb(scheme), 0xffff_ffff)
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixed.getArgb(scheme), 0xff8c_0002)
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme), 0xff62_0001)
  ...
  func testDarkSchemeFidelityMinContrast() {
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiary.getArgb(scheme), 0xffff_5542)
    XCTAssertEqual(MaterialDynamicColors.onTertiary.getArgb(scheme), 0xff5c_0001)
    XCTAssertEqual(MaterialDynamicColors.tertiaryContainer.getArgb(scheme), 0xff7b_0001)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryContainer.getArgb(scheme), 0xffff_7d6b)
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixed.getArgb(scheme), 0xffa5_0906)
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme), 0xff7b_0001)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryFixed.getArgb(scheme), 0xffff_b0a4)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryFixedVariant.getArgb(scheme), 0xffff_7664)
  }
  ...
  func testDarkSchemeFidelityStandardContrast() {
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiary.getArgb(scheme), 0xffff_b4a9)
    XCTAssertEqual(MaterialDynamicColors.onTertiary.getArgb(scheme), 0xff69_0001)
    XCTAssertEqual(MaterialDynamicColors.tertiaryContainer.getArgb(scheme), 0xff8c_0002)
    XCTAssertEqual(MaterialDynamicColors.onTertiaryContainer.getArgb(scheme), 0xffff_cfc7)
  ...
  func testDarkSchemeFidelityMaxContrast() {
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiary.getArgb(scheme), 0xffff_f9f8)
    XCTAssertEqual(MaterialDynamicColors.onTertiary.getArgb(scheme), 0xff00_0000)
    XCTAssertEqual(MaterialDynamicColors.tertiaryContainer.getArgb(scheme), 0xffff_baaf)
    ...
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixed.getArgb(scheme), 0xffff_e0db)
    XCTAssertEqual(MaterialDynamicColors.tertiaryFixedDim.getArgb(scheme), 0xffff_baaf)
