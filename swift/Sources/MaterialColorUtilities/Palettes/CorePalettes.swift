...
protocol CorePalettes {
  var primary: TonalPalette { get }
  var secondary: TonalPalette { get }
  var tertiary: TonalPalette { get }
  var neutral: TonalPalette { get }
  var neutralVariant: TonalPalette { get }
}
