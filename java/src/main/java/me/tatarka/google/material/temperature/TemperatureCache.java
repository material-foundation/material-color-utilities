...
/**
 * Design utilities using color me.tatarka.google.material.temperature theory.
 *
...
public final class TemperatureCache {
   ...
   *
   * <p>The colors are equidistant in me.tatarka.google.material.temperature and adjacent in hue.
   */
  ...
  /**
   * A set of colors with differing hues, equidistant in me.tatarka.google.material.temperature.
   *
  ...
  public List<Hct> getAnalogousColors(int count, int divisions) {
    ...
    while (allColors.size() < divisions) {
      ...
      int indexAddend = 1;
      // Keep adding this hue to the answers until its me.tatarka.google.material.temperature is
      // insufficient. This ensures consistent behavior when there aren't
      // `divisions` discrete steps between 0 and 360 in hue with `tempStep`
      // delta in me.tatarka.google.material.temperature between them.
      //
   ...
   *
   * @param hct HCT to find the relative me.tatarka.google.material.temperature of.
  ...
  public double getRelativeTemperature(Hct hct) {
    ...
    // Handle when there's no difference in me.tatarka.google.material.temperature between warmest and
  ...
  /** Keys of HCTs in getHctsByTemp, values of raw me.tatarka.google.material.temperature. */
