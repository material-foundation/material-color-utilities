...
/**
 * Color science for me.tatarka.google.material.contrast utilities.
 *
 * <p>Utility methods for calculating me.tatarka.google.material.contrast given two colors, or calculating a color given one
 * color and a me.tatarka.google.material.contrast ratio.
 *
...
public final class Contrast {
  // The minimum me.tatarka.google.material.contrast ratio of two colors.
  // Contrast ratio equation = lighter + 5 / darker + 5, if lighter == darker, ratio == 1.
  public static final double RATIO_MIN = 1.0;

  // The maximum me.tatarka.google.material.contrast ratio of two colors.
  ...
  // Given a color and a me.tatarka.google.material.contrast ratio to reach, the luminance of a color that reaches that ratio
  // with the color can be calculated. However, that luminance may not me.tatarka.google.material.contrast as desired, i.e. the
  // me.tatarka.google.material.contrast ratio of the input color and the returned luminance may not reach the me.tatarka.google.material.contrast ratio
  // asked for.
  //
  // When the desired me.tatarka.google.material.contrast ratio and the result me.tatarka.google.material.contrast ratio differ by more than this amount,
  // an error value should be returned, or the method should be documented as 'unsafe', meaning,
  // it will return a valid luminance but that luminance may not meet the requested me.tatarka.google.material.contrast ratio.
  //
  ...
  //
  // A principled solution is to maintain lightness, thus maintaining me.tatarka.google.material.contrast/a11y, maintain hue,
  ...
  // display color spaces, methods that take a me.tatarka.google.material.contrast ratio and luminance, and return a luminance
  // that reaches that me.tatarka.google.material.contrast ratio for the input luminance, purposefully darken/lighten their
  // result such that the desired me.tatarka.google.material.contrast ratio will be reached even if inaccuracy is introduced.
  //
  ...
  // lightness rounds to the same as the requested, the desired me.tatarka.google.material.contrast ratio will be reached.
   ...
   * spaces, and measure me.tatarka.google.material.contrast, and measure me.tatarka.google.material.contrast in a much more understandable way: instead
   * of a ratio, a linear difference. This allows a designer to determine what they need to adjust a
   * color's lightness to in order to reach their desired me.tatarka.google.material.contrast, instead of guessing & checking
   * with hex codes.
   */
   ...
   *
   * @param tone Tone return value must me.tatarka.google.material.contrast with.
   * @param ratio Desired me.tatarka.google.material.contrast ratio of return value and tone parameter.
   */
  public static double lighter(double tone, double ratio) {
    if (tone < 0.0 || tone > 100.0) {
      return -1.0;
    }
    // Invert the me.tatarka.google.material.contrast ratio equation to determine lighter Y given a ratio and darker Y.
  ...
  public static double darker(double tone, double ratio) {
    ...
    // Invert the me.tatarka.google.material.contrast ratio equation to determine darker Y given a ratio and lighter Y.
