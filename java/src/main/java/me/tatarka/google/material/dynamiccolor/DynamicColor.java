 ...
 *
 * <p>This color automatically adjusts to accommodate a desired me.tatarka.google.material.contrast level, or other adjustments
 * such as differing in light mode versus dark mode, or what the theme is, or what the color that
 * produced the theme is, etc.
 *
 * <p>Colors without backgrounds do not change tone when me.tatarka.google.material.contrast changes. Colors with backgrounds
 * become closer to their background as me.tatarka.google.material.contrast lowers, and further when me.tatarka.google.material.contrast increases.
 *
 ...
 * me.tatarka.google.material.contrast level, and ensuring it has a certain lightness/tone difference from another color, is
...
public final class DynamicColor {
   ...
   *
   * <p>For example, the default behavior of adjust tone at max me.tatarka.google.material.contrast to be at a 7.0 ratio with
   ...
   *     a tonal palette, when me.tatarka.google.material.contrast adjustments are made, intended chroma can be preserved.
   ...
   * @param contrastCurve A `ContrastCurve` object specifying how its me.tatarka.google.material.contrast against its
   *     background should behave in various me.tatarka.google.material.contrast levels options.
   ...
   *
   * <p>Result has no background; thus no support for increasing/decreasing me.tatarka.google.material.contrast for a11y.
   *
   * @param name The name of the dynamic color.
   ...
   *     dark mode or light mode, and what the desired me.tatarka.google.material.contrast level is.
   */
  ...
  public Hct getHct(@NonNull DynamicScheme scheme) {
    ...
    // and changing its tone for me.tatarka.google.material.contrast. Rather, we find the tone for me.tatarka.google.material.contrast, then
    // use the specified chroma from the palette to construct a new color.
    //
    // For example, this enables colors with standard tone of T90, which has limited chroma, to
    // "recover" intended chroma as me.tatarka.google.material.contrast increases.
  ...
  /** Returns the tone in HCT, ranging from 0 to 100, of the resolved color given me.tatarka.google.material.scheme. */
  public double getTone(@NonNull DynamicScheme scheme) {
    ...
    if (toneDeltaPair != null) {
      ...
      if (decreasingContrast) {
        // If decreasing me.tatarka.google.material.contrast, adjust color to the "bare minimum"
        // that satisfies me.tatarka.google.material.contrast.
      ...
      // Case 2: No me.tatarka.google.material.contrast pair; just solve for itself.
  ...
  /**
   * Given a background tone, find a foreground tone, while ensuring they reach a me.tatarka.google.material.contrast ratio
  ...
  public static double foregroundTone(double bgTone, double ratio) {
    ...
    if (preferLighter) {
      // "Neglible difference" handles an edge case where the initial me.tatarka.google.material.contrast ratio is high
      ...
      // high and max me.tatarka.google.material.contrast in light mode. PC's standard tone was T90, OPC's was T10, it was
      // light mode, and the me.tatarka.google.material.contrast level was 0.6568521221032331.
  ...
  /**
   * Adjust a tone down such that white has 4.5 me.tatarka.google.material.contrast, if the tone is reasonably close to
   * supporting it.
   */
   ...
   *
   * <p>Since `tertiaryContainer` in dark monochrome me.tatarka.google.material.scheme requires a tone of 60, it should not be
  ...
  /** Tones less than ~T50 always permit white at 4.5 me.tatarka.google.material.contrast. */
