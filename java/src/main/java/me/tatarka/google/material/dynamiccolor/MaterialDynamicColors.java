...
public final class MaterialDynamicColors {
   ...
   * they are, they can't be adjusted for me.tatarka.google.material.contrast.* For now, they will be set with no background,
   * and those won't adjust for me.tatarka.google.material.contrast, avoiding issues.
   *
   * <p>* For example, if the same color is on a white background _and_ black background, there's no
   * way to increase me.tatarka.google.material.contrast with either without losing me.tatarka.google.material.contrast with the other.
   */
